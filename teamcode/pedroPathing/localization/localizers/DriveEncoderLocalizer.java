...
public class DriveEncoderLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0085;
    public static double STRAFE_TICKS_TO_INCHES = -0.0094;
    public static double TURN_TICKS_TO_RADIANS = 0.017;
    public static double ROBOT_WIDTH = 13.25;
    ...
    public void getlf() {
        leftFront.getMultiplier();
    }
    public void getrf() {
        rightFront.getMultiplier();
    }
    public void getlr() {
        leftRear.getMultiplier();
    }
    public void getrr() {
        rightRear.getMultiplier();
    }
